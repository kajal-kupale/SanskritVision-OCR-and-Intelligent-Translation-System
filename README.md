# Sanskrit OCR and Translation System
...
- OCR-based Sanskrit text extraction from images
- Manual Sanskrit text input
- Translation into English and Marathi
- Script-based language detection with alerts
